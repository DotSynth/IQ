            ...
            try
            {
                ...
                using (var conn = new NpgsqlConnection(connString))
                {
                    ...
                    using (var cmd = new NpgsqlCommand())
                    {
                        ...
                        cmd.CommandText = "INSERT INTO WarehouseReturnInwards (ReturnID, ModelID, BrandID, QuantityReturned, ReturnedBy, ReasonForReturn, SignedBy) VALUES (@ReturnID, @modelID, @brandID, @qtyReturned, @returnedBy, @reasonForReturn, @signedBy)";
