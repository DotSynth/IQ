            ...
            try
            {
                ...
                using (var conn = new NpgsqlConnection(connString))
                {
                    ...
                    using (var cmd = new NpgsqlCommand())
                    {
                        ...
                        cmd.CommandText = "INSERT INTO WarehouseTransferOutwards (TransferID, ModelID, BrandID, AddOns, QuantityTransferred, TransferredTo, SignedBy, TransferredProductPrice) VALUES (@TransferID, @modelID, @brandID, @addOns, @qtyTransferred, @transferredTo, @signedBy, @TInProductPrice)";
